...
/**
 * 属性&属性分组关联; InnoDB free: 5120 kB
 *
 * @author MrZ
 * @email zww@atguigu.com
 * @date 2020-04-26 21:35:35
 */
@Api(tags = "属性&属性分组关联; InnoDB free: 5120 kB 管理")
@RestController
...
public class AttrAttrgroupRelationController {
    ...
    public Resp<String> deleteByArrIdArrGroupId(@RequestBody List<AttrAttrgroupRelationEntity> attrgroupRelationEntities) {

        this.attrAttrgroupRelationService.deleteByArrIdArrGroupId(attrgroupRelationEntities);
    ...
    public Resp<PageVo> list(QueryCondition queryCondition) {
        PageVo page =
                attrAttrgroupRelationService.queryPage(queryCondition);
    ...
    public Resp<AttrAttrgroupRelationEntity> info(@PathVariable("id"
    ) Long id) {
        AttrAttrgroupRelationEntity attrAttrgroupRelation =
                attrAttrgroupRelationService.getById(id);

...
public class OssController {
    ...
    String accessId = "LTAI4GJGESPrNNBppwN39f2A"; // 请填写您的AccessKeyId。
    String accessKey = "hVTUTBtkK29KB8O1kfFq5OdxBqH7wi"; //
    // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的
    // endpoint。
    String bucket = "ggmall02"; // 请填写您的 bucketname 。
    ...
    public Resp<Object> policy() throws UnsupportedEncodingException {
        ...
        OSSClient client = new OSSClient(endpoint, accessId,
                accessKey);
        ...
        String postSignature =
                client.calculatePostSignature(postPolicy);

        Map<String, String> respMap = new LinkedHashMap<String,
                String>();

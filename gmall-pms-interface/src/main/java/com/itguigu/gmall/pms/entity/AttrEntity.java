...
public class AttrEntity implements Serializable {
     ...
     * 是否需要检索[0-不需要，1-需要]
     */
    @ApiModelProperty(name = "searchType", value = "是否需要检索[0-不需要，1" +
            "-需要]")
    private Integer searchType;
    /**
     * 值类型[0-为单个值，1-可以选择多个值]
     */
    @ApiModelProperty(name = "valueType", value = "值类型[0-为单个值，1" +
            "-可以选择多个值]")
     ...
     * 属性类型[0-销售属性，1-基本属性]
     */
    @ApiModelProperty(name = "attrType", value = "属性类型[0-销售属性，1" +
            "-基本属性]")

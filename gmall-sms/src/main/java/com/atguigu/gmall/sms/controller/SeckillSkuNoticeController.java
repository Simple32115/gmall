 ...
 */
@Api(tags = "秒杀商品通知订阅; InnoDB free: 5120 kB 管理")
@RestController
...
public class SeckillSkuNoticeController {
    ...
    public Resp<PageVo> list(QueryCondition queryCondition) {
        PageVo page =
                seckillSkuNoticeService.queryPage(queryCondition);
    ...
    public Resp<SeckillSkuNoticeEntity> info(@PathVariable("id") Long id) {
        SeckillSkuNoticeEntity seckillSkuNotice =
                seckillSkuNoticeService.getById(id);

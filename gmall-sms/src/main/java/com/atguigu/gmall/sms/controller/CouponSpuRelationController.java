 ...
 */
@Api(tags = "优惠券与产品关联; InnoDB free: 5120 kB 管理")
@RestController
...
public class CouponSpuRelationController {
    ...
    public Resp<PageVo> list(QueryCondition queryCondition) {
        PageVo page =
                couponSpuRelationService.queryPage(queryCondition);
    ...
    public Resp<CouponSpuRelationEntity> info(@PathVariable("id") Long id) {
        CouponSpuRelationEntity couponSpuRelation =
                couponSpuRelationService.getById(id);

...
/**
 * 首页专题表【jd首页下面很多专题，每个专题链接新的页面，展示专题商品信息】; InnoDB free: 5120 kB
 *
 * @author MrZ
 * @email zww@atguigu.com
 * @date 2020-04-29 11:02:57
 */
@Api(tags = "首页专题表【jd首页下面很多专题，每个专题链接新的页面，展示专题商品信息】; InnoDB free: " +
        "5120 kB 管理")
@RestController
...
public class HomeSubjectController {
    ...
    public Resp<HomeSubjectEntity> info(@PathVariable("id") Long id) {
        HomeSubjectEntity homeSubject =
                homeSubjectService.getById(id);

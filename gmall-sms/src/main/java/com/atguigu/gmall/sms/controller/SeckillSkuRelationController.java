 ...
 */
@Api(tags = "秒杀活动商品关联; InnoDB free: 5120 kB 管理")
@RestController
...
public class SeckillSkuRelationController {
    ...
    public Resp<PageVo> list(QueryCondition queryCondition) {
        PageVo page =
                seckillSkuRelationService.queryPage(queryCondition);
    ...
    public Resp<SeckillSkuRelationEntity> info(@PathVariable("id") Long id) {
        SeckillSkuRelationEntity seckillSkuRelation =
                seckillSkuRelationService.getById(id);

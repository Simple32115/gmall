...
public class MemberController {
    ...
    public Resp<Object> registry(MemberEntity memberEntity, @RequestParam("code")String code){
       this.memberService.registry(memberEntity,code);
    ...
    public Resp<Boolean> queryData(@PathVariable("data")String data,@PathVariable("type")Integer type){

        Boolean b = this.memberService.queryData(data,type);
